 ...
 * instances of {@link java.io.File} and may throw {@link java.io.IOException} when appropriate).
 * At the same time, it is designed to be fairly robust in that it is thread-safe and does as much
 * error checking as I find reasonable at this level. Client code is still responsible for proper
...
public final class PdBase {
    ...
    private final static Map<String, Long> bindings = new HashMap<>();
    private final static Map<Integer, Long> patches = new HashMap<>();
     ...
     * @throws java.io.IOException thrown if the file doesn't exist or can't be opened
     */
